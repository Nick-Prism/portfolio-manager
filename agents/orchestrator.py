...
You have received analysis from four specialist agents and a Bull vs Bear debate.
...
- GTT_TARGET: Place a Good Till Triggered order at a target price above current price
  (take profit if price rises to this level)
- GTT_STOP: Place a GTT stop-loss order below current price
  (cut losses if price falls to this level)
